            ...
            <div class="card">
              ...
              <div >
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-10">
                          <input type="text" name="title" class="form-control" placeholder="Title" value="" maxlength="100" required="">
                      </div>
                  </div><!--form-group-->
              ...
              <button class="btn btn-sm btn-primary float-right" type="submit">Create Category</button>
          </div><!--card-footer-->
      </div><!--card-->
  </form>
    </div><!--fade-in-->
